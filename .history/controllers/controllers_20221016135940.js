...
const scheduleMeeting1 = async (req,res)=>{
   ...
   meetingEnd = moment(meetingEnd,'YYYY-MM-DD hh:mm:ss a')
    ...
    Dates.create({
        name:"randomdate",
        Date:moment("2022/10/25 10:10",'YYYY-MM-DD hh:mm').tz('Asia/Kolkata').format().toDate()
    }).then((datesfromdb)=>{
        console.log(moment("2022/10/25 10:10",'YYYY-MM-DD hh:mm').tz('Asia/Kolkata').format().toDate());
