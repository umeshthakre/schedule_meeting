...
const scheduleMeeting1 = async (req,res)=>{
   ...
   meetingEnd = moment(meetingEnd,'YYYY-MM-DD hh:mm:ss a')
    ...
    Dates.create({
        name:"randomdate",
        Date:moment("2022/10/25 10:10",'YYYY-MM-DD HH:mm').format('YYYY-MM-DD HH:mm')
    }).then((datesfromdb)=>{
        console.log(moment("2022/10/25 8:00",'YYYY-MM-DD HH:mm').format('YYYY-MM-DD HH:mm'))
        console.log(moment.utc(datesfromdb).local().format('YYYY-MM-DD HH:mm:ss'));
    })
    .catch((err)=>console.log(err))
